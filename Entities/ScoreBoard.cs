...
{
    //HIEN THI VA QUAN LY DIEM SO CUA NGUOI CHOI
    public class ScoreBoard : IGameEntity
    {
        ...
        //Kiem tra xem nguoi choi co diem so cao nhat hay chua
        ...
        //Ve diem so va hieu ung flash neu co
        ...
        // Ve tung chu so cua diem so len man hinh
        ...
        //Cap nhat diem so va kiem tra de kich hoat hieu ung flash khi hang tram doi
        ...
        //Chia cac chu so cua so nguyen thanh mang cac chu so
        ...
        //Xac dinh toa do tren texture cho chu so cu the
