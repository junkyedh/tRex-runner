...
{
    //class chinh ke thua tu class Game cua XNA Framework
    public class TRexRunnerGame : Game
    {
        // enum quan ly che do hien thi cua so la mac dinh hay thu phong
        ...
        // Dinh nghia cac hang so hay thuoc tinh
        ...
        private const string SAVE_FILE_NAME = "SaveHighCore.data";
        ...
        //Tai cac tai nguyen can thiet cho game
        //Khoi tao va cau hinh cac doi tuong quan trong cua game
        protected override void LoadContent()
        {
            ...
            //Doc trang thai luu tu tep de khoi phuc trang thai truoc do cua game
            LoadSaveState();
        ...
        //Cap nhat trang thai tro choi dua tren thoi gian troi qua
        ...
        //Luu trang thai cao diem va thoi diem dat duoc no
